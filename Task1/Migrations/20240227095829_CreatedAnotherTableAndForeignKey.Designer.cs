...
namespace Task1.Migrations
{
    ...
    [Migration("20240227095829_CreatedAnotherTableAndForeignKey")]
    partial class CreatedAnotherTableAndForeignKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Task1.Data.state", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Task1.Data.sampledata", b =>
                {
                    b.HasOne("Task1.Data.state", "state")
                        .WithMany("sampledata")
